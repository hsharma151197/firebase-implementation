    ...
    return (
      <tr className="Date row">
        {this.props.datesArr.map((current, index) =>
          ...
          (this.props.reminders && `${this.props.year}${this.props.month}${current}` in this.props.reminders && this.props.reminders[`${this.props.year}${this.props.month}${current}`].length ? (
            <td
