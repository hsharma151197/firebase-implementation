...
class Events extends Component {
  ...
  handleReminder = reminder => {
    ...
    if (this.props.reminders && !(key in this.props.reminders)) {
      remindersTemp = {
      ...
      remindersTemp = {
        ...this.props.reminders,
        [key]: [...this.props.reminders[key], reminder]
      };
      this.setState({
        reminders: remindersTemp
      });
      ...
      <section className="events">
        ...
        >
          <ul className="events__container-parent">
            Current Events:
            {this.props.reminders && `${this.props.selectedYear}${this.props.selectedMonth}${
              this.props.selectedDate
            }` in this.props.reminders ? (
              this.props.reminders[
